...
export default function ManagementAccountingAccountsPage() {
  ...
  return (
    <>
      <PageHeader title="บัญชีเงินสด/ธนาคาร" description="จัดการและดูข้อมูลบัญชีการเงิน">
        <Button asChild>
          <Link href="/management/accounting/accounts/new">
                    ...
                    <TableRow key={account.id}>
                      ...
                      <TableCell className="text-right">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent>
                            <DropdownMenuItem asChild><Link href={`/management/accounting/accounts/${account.id}/ledger`}><BookOpen className="mr-2"/> ดูรายการเข้า-ออก</Link></DropdownMenuItem>
                            <DropdownMenuItem asChild><Link href={`/management/accounting/accounts/${account.id}`}><Edit className="mr-2"/> แก้ไข</Link></DropdownMenuItem>
