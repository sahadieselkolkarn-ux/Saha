...
export default function BatchBillingNotePage() {
  ...
  const handlePreview = (docId: string) => router.push(`/office/documents/${docId}`);
  const handlePrint = (docId: string) => router.push(`/office/documents/${docId}?print=1&autoprint=1`);
