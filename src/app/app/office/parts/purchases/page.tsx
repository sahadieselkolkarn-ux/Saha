...
import { collection, onSnapshot, query, orderBy, type FirestoreError } from "firebase/firestore";
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
      ...
      if (error.message.includes("permission-denied")) {
        toast({ variant: "destructive", title: "ไม่มีสิทธิ์เข้าถึงข้อมูล", description: "คุณไม่มีสิทธิ์ในการดูรายการจัดซื้อ" });
      } else {
                                ...
                                <TableRow key={doc.id}>
                                    ...
                                    <TableCell className="text-right">
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent>
                                                <DropdownMenuItem onSelect={() => router.push(`/app/office/parts/purchases/${doc.id}`)}>
                                                    ดูรายละเอียด
                                                </DropdownMenuItem>
                                            </DropdownMenuContent>
                                        </DropdownMenu>
